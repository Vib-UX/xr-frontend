    ...
    <Card className='w-full  overflow-hidden rounded-3xl border border-blue-100'>
      <CardContent className='p-6'>
        ...
        <p className='text-lg text-gray-800 mb-6 text-center'>
          Team Goggins ready for Challenge? Time to show Team Lazar who is the
          real boss.
        </p>
        <Card className='rounded-2xl border border-blue-100 mb-6'>
          <CardContent className='p-4'>
            ...
            <p className='text-gray-800 mb-4'>
              <span className='font-semibold'>Squat Marathon:</span> Lets see
              who can Do the most squats within 5 minutes
            </p>
            <img
