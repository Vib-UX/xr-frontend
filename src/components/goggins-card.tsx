    ...
    <Card className='w-full max-w-3xl overflow-hidden rounded-3xl border border-gray-200'>
      ...
      <CardContent className='p-6'>
        ...
        <p className='text-gray-700 mb-6'>
          David Goggins, a former Navy SEAL, is known for extreme mental
          toughness. His program builds both physical endurance and mental
          resilience, emphasizing discipline and grit.
        </p>
